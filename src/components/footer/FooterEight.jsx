    ...
    <div className="row justify-content-end">
      <div className="col-xl-4 col-lg-3 col-12 footer-about-widget">
        ...
        <ul className="font-rubik mt-10">
          <li>
            <a href="mailto:support@cliquedecisions.com">support@cliquedecisions.com</a>
          </li>
          <li>
            <a href="tel:+222 222 2222" className="phone">
              222 222 2222
            </a>
          </li>
        </ul>
      ...
      <div className="col-lg-3 col-md-4 footer-list">
        ...
        <ul>
          ...
          <li>
            <Link to="/features-customer-support">App</Link>
          </li>
          <li>
